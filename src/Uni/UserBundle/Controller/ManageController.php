...
class ManageController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniUserBundle:Manage:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UniUserBundle:Manage:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('UniUserBundle:Manage:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UniUserBundle:Manage:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new UserType(), $entity, array(
            'action' => $this->generateUrl('user_manage_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('user_manage_delete', array('id' => $id)))
            ->setMethod('DELETE')
    ...
    public function sendAction(Request $request) {
        ...
        $message = \Swift_Message::newInstance()
            ...
            ->setFrom('noreply@goldsecurity.cl')
            ->setTo('gfiguero@gmail.com')
            ->setBody(
                $this->renderView(
                    'UniUserBundle:Manage:send.html.twig',
                    array('name' => 'Nombre')
                ),
                'text/plain'
            )
